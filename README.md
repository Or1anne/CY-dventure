...
## Compile 
Pour compiler sur Linux, vous devez d'abord faire make puis bin/CYdventure.exe . Pour supprimer les dossiers crées par le makefile dans le terminal, on fait la commmande make clean 
